describe("Cadastro de Motoboy", () => {
  before(() => {
    ...
    cy.get('[data-testid="login-input"]').type("kaos");
  ...
  it("Deve cadastrar um novo motoboy", () => {
    ...
    cy.get('[data-testid="nome-entregador-input"]').type("Asteroid Destroyer");
    cy.get('[data-testid="telefone-entregador-input"]').type("16998774111");
    cy.get('[data-testid="placa-entregador-input"]').type("JAV1487");
    cy.get('[data-testid="usuario-entregador-input"]').type("AstDest2");
    cy.get('[data-testid="senha-entregador-input"]').type("123");
